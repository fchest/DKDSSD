...
def main():
    scoreFile="./Joint_fusion_logit_inter1/test_clean.txt"
    labelFile="/data4/dingmingming/data_human/ASVspoof/ASVspoof2019data/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt"
